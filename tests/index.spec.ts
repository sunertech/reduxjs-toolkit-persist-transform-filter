...
describe("reduxjs-toolkit-persist-transform-filter", () => {
  describe("persistFilter", () => {
    ...
    it("should return a subset, given one key", () => {
      expect(persistFilter({ a: "a", b: "b", c: "c" }, "a")).to.deep.equal({
        a: "a",
      });
    });
    ...
    it("should return a subset, given an array of keys", () => {
      ...
      expect(
        persistFilter({ a: "a", b: "b", c: "c" }, ["a", "b"])
      ).to.deep.equal({ a: "a", b: "b" });
    });

    it("should return a subset, given one key path", () => {
      expect(
        persistFilter({ a: { b: "b", c: "c" }, d: "d" }, "a.b")
      ).to.deep.equal({ a: { b: "b" } });
      expect(
        persistFilter({ a: { b: "b", c: "c" }, d: "d" }, "a.c")
      ).to.deep.equal({ a: { c: "c" } });
    });
    ...
    it("should return a subset, given an array of key paths", () => {
      ...
      expect(
        persistFilter({ a: { b: "b", c: "c" }, d: "d" }, ["a.b", "a.c"])
    ...
    it("should return a subset, given an object that contains a path and a filterFunction", () => {
      ...
      expect(
        persistFilter(store, [{ path: "a", filterFunction: (item) => item.x }])
      ).to.deep.equal({
        a: { id1: { x: true, b: "b" }, id2: { x: true, b: "bb" } },
      });
      expect(
        persistFilter(store, [
          { path: "a", filterFunction: (item) => item.b === "bb" },
        ])
      ).to.deep.equal({ a: { id2: { x: true, b: "bb" } } });
    });
  });
  ...
  describe("persistFilter (blacklist)", () => {
    it("should return a subset, given one key", () => {
      expect(
        persistFilter({ a: "a", b: "b", c: "c" }, "a", "blacklist")
      ).to.deep.equal({ b: "b", c: "c" });
    });
    ...
    it("should return a subset, given an array of keys", () => {
      ...
      expect(
        persistFilter({ a: "a", b: "b", c: "c" }, ["a", "b"], "blacklist")
      ).to.deep.equal({ c: "c" });
    });

    it("should return a subset, given one key path", () => {
      expect(
        persistFilter({ a: { b: "b", c: "c" }, d: "d" }, "a.b", "blacklist")
      ).to.deep.equal({ a: { c: "c" }, d: "d" });
      expect(
        persistFilter({ a: { b: "b", c: "c" }, d: "d" }, "a.c", "blacklist")
      ).to.deep.equal({ a: { b: "b" }, d: "d" });
    });
    ...
    it("should return a subset, given an object that contains a path and a filterFunction", () => {
      ...
      expect(
        persistFilter(
          ...
          [{ path: "a", filterFunction: (item) => item.x }],
          "blacklist"
        )
      ).to.deep.equal({ a: { id3: { x: false, b: "bbb" } }, d: "d" });
      expect(
        persistFilter(
          JSON.parse(JSON.stringify(store)),
          [{ path: "a", filterFunction: (item) => item.b === "bb" }],
        ...
        a: { id1: { x: true, b: "b" }, id3: { x: false, b: "bbb" } },
        d: "d",
      });
    });
  ...
  describe("createWhitelistFilter", () => {
    ...
    it("should load a subset", () => {
      const myFilter = createWhitelistFilter("reducerName", undefined, [
        "a.b",
        "d",
      ]);
  ...
  describe("createBlacklistFilter", () => {
    ...
    it("should load a subset", () => {
      let state = { a: { b: "b", c: "c" }, d: "d" };
      const myFilter = createBlacklistFilter("reducerName", undefined, [
        "a.b",
        "d",
      ]);
